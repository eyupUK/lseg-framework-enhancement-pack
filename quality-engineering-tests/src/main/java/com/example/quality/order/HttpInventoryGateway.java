    ...
    public boolean reserve(String sku, int quantity, String idempotencyKey) {
        try {
            String body = objectMapper.writeValueAsString(
                    new ReservationRequest(sku, quantity, idempotencyKey));
            ...
            ReservationResponse reservation = objectMapper.readValue(
                    response.body(),
            ...
            throw new IllegalStateException(
                    "Inventory service returned an unexpected reservation response");
